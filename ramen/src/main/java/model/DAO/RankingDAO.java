...
public class RankingDAO {
	...
	//店舗平均評価点計算
		public List<ShopBean> shopRank() throws SQLException, ClassNotFoundException{
			...
			String sql ="SELECT AVG(c.rate) AS average_rate,shop_name,s.photo FROM m_comment c INNER JOIN m_shop s ON c.shop_id = s.shop_id GROUP BY s.shop_id ORDER BY average_rate DESC LIMIT 5" ; 
